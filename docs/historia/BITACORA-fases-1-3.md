# Bitácora archivada — fases 1 a 3 (2026-08-02 a 2026-08-22)

> **Archivo congelado.** Estas entradas se movieron aquí desde
> [BITACORA.md](../BITACORA.md) el 2026-09-02, cuando el diario pasó de 3531
> líneas y consultarlo empezó a costar más que escribirlo. **No se ha borrado ni
> editado nada**: el texto es idéntico al original, y el historial de git lo
> confirma.
>
> Cubren las fases 1 a 3, ya cerradas: identificar los hilos, descifrar el bus,
> montar la sonda y verificar los cuatro canales de accionamiento. Lo que sigue
> vivo de todo esto está destilado en los documentos temáticos
> ([HARDWARE.md](../HARDWARE.md), [PROTOCOLO.md](../PROTOCOLO.md),
> [SEGURIDAD.md](../SEGURIDAD.md)) y en los ADR de
> [DECISIONS.md](../DECISIONS.md), que son inmutables y no se han tocado.
